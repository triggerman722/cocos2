...
public class InvoicesApiController implements InvoicesApi {
    ...
    public ResponseEntity<List<Invoice>> invoicesGet( @NotNull @ApiParam(value = "The ID of the invoice.", required = true) @RequestParam(value = "invoiceid", required = true) BigDecimal invoiceid) {
        // do some magic!
